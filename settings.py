...
CUSTOM_FOLDER_NAME: str = _config_data.get("CUSTOM_FOLDER_NAME", "created_maps") # If provided, places generated channel-packed maps into a custom folder.
...
# The G/RGB image type is used in validate_packing_modes to ensure that an RGB image is not mapped to a single channel without explicitly specifying the channel using .R or _R.